...
from api.src.infrastructure.primary.middleware.password_hasher import BcryptPasswordHasher
from api.src.infrastructure.primary.middleware.jwt_handler import JwtHandler
from api.src.core.credential_encryptor import FernetCredentialEncryptor
from domain.ports.i_task_queue import ITaskQueue
from domain.ports.i_credential_encryptor import ICredentialEncryptor
from api.src.infrastructure.secondary.connectors.connector_registry import ConnectorRegistry
from api.src.infrastructure.primary.middleware.mock_task_queue import MockTaskQueue
...
from api.src.infrastructure.secondary.database.repositories.project_repository import SqlProjectRepository
...
from api.src.infrastructure.secondary.database.repositories.verification_rule_repository import SqlVerificationRuleRepository

from api.src.application.use_cases.main.launch_verification import LaunchVerificationUseCase
from application.use_cases.configure_connector import ConfigureConnectorUseCase
from api.src.application.use_cases.login import LoginUseCase
from api.src.application.use_cases.crud_organization import (
...
from api.src.application.use_cases.main.manage_profile import ManageProfileUseCase
from api.src.application.use_cases.crud_project import (
...
from api.src.application.use_cases.crud_user import (
    RegisterUserUseCase,
    CreateUserUseCase,
...
async def get_current_user(
    ...
    if user.organization_id is not None:
        from api.src.infrastructure.secondary.database.session import set_current_organization_id
...
def get_task_queue() -> ITaskQueue:
    try:
        from api.src.infrastructure.secondary.queue import CeleryTaskQueue
