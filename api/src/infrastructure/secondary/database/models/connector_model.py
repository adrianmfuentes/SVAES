...
class ConnectorInstanceModel(Base):
    ...
    status = Column(SAEnum(ConnectorStatus, name='connector_status', values_callable=lambda enums: [e.value for e in enums]), nullable=False, default=ConnectorStatus.INACTIVO)
