...
_RULE_NAMES: dict[str, dict[str, str]] = {
    "es": {
        ...
        "artifact_fetch_error": "Error al recuperar artefacto",
    },
    "en": {
        ...
        "has_high_severity_vulnerabilities": "High severity vulnerabilities",
        "has_critical_vulnerabilities": "Critical vulnerabilities",
        "has_open_high_priority_issues": "Open high priority issues",
        "has_code_smells": "Code smells",
        "has_security_hotspots": "Security hotspots",
        "has_uncovered_code": "Uncovered code",
        "has_duplicated_code": "Duplicated code",
        "has_blocking_issues": "Blocking issues",
        "meets_minimum_test_coverage": "Minimum test coverage",
        "meets_maximum_complexity": "Maximum complexity",
        "artifact_fetch_error": "Artifact fetch error",
    },
}
