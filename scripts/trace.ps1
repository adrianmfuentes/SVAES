...
$PLAN = @(
    ...
    @{ Id = "TC-UNI-API-02"; Level = "Unitaria";     Section = "7.2.3"; Desc = "rol=INVALID -> 403";                             Tech = "Base Choice"; Tool = "pytest" },
    ...
    @{ Id = "TC-UNI-FE-GRD-04"; Level = "Unitaria";  Section = "7.2.5.1"; Desc = "U1/OPERATOR en /releases/verify -> canActivate=true"; Tech = "CE+BC"; Tool = "Jest" },
...
function Parse-Text {
    ...
    $passPattern = "\bPASSED\b|\bPASS\b|\bSKIPPED\b|\bSKIP\b|✓|✔|\bok\b|\bOK\b"
